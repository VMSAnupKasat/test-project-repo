...
Below are the steps to create a new asset as- Document Template type:

- Browse to _**[Chrysalis](https://aka.ms/chrysalis)**_, select **Explore Assets** from Assets menu.

- Click the **Add Asset** button and select **Document Template** from the Asset Type dropdown.
